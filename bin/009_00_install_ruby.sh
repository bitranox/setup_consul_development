...
function install_ruby {
    banner "Install Ruby"
    local sudo_command_prefix=$(get_sudo_command_prefix)
    ${sudo_command_prefix} apt-get install zlib1g -y
    ${sudo_command_prefix} apt-get install zlib1g-dev -y
    ${sudo_command_prefix} apt-get install ruby-full -y
    ${sudo_command_prefix} apt-get install nodejs -y
    ${sudo_command_prefix} apt-get install npm -y
}
